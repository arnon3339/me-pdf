...
export const thaiTranslations: Locale = {
  code: 'th',
  name: 'ภาษาไทย',
  translations: {
    zoom: {
    ...
    page: {
      settings: 'การตั้งค่าหน้า',
      single: 'หน้าเดียว',
      twoOdd: 'สองหน้า (คี่)',
      twoEven: 'สองหน้า (คู่)',
      vertical: 'แนวตั้ง',
      horizontal: 'แนวนอน',
      spreadMode: 'โหมดหน้าคู่',
      scrollLayout: 'รูปแบบการเลื่อน',
      rotation: 'การหมุนหน้า',
    },
    rotate: {
      clockwise: 'หมุนตามเข็มนาฬิกา',
      counterClockwise: 'หมุนทวนเข็มนาฬิกา',
    },
    mode: {
      view: 'ดู',
      annotate: 'เขียนประกอบ',
      shapes: 'รูปร่าง',
      redact: 'ปิดทับข้อมูล',
    },
    tabs: {
      overflowMenu: 'แท็บเพิ่มเติม',
    },
    annotation: {
      text: 'ข้อความ',
      highlight: 'ไฮไลท์',
      ...
      ink: 'วาดเขียน',
      stamp: 'ประทับตรา',
      overflowTools: 'เครื่องมือเพิ่มเติม',
      fontSettings: 'ตั้งค่าตัวอักษร',
      image: 'รูปภาพ',
    },
    redaction: {
      area: 'ปิดทับพื้นที่',
    ...
    search: {
      ...
      placeholder: 'ค้นหา',
      close: 'ปิดการค้นหา',
      caseSensitive: 'ตัวพิมพ์เล็ก-ใหญ่',
      wholeWord: 'ทั้งคำ',
      resultsFound: 'พบ {count} รายการ',
      previousResult: 'ก่อนหน้า',
      nextResult: 'ถัดไป',
      page: 'หน้า {number}',
    },
  },
