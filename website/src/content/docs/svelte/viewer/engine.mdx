...
<CodeExample
  codePaths={[
    "../../examples/svelte-tailwind/src/examples/viewer/engine-example.svelte"
  ]}
>
  <EngineExample />
</CodeExample>
...
- **Add annotations** → Use the [Annotation Plugin](/docs/svelte/headless/plugins/plugin-annotation)
- **Change zoom** → Use the [Zoom Plugin](/docs/svelte/headless/plugins/plugin-zoom)
- **Navigate pages** → Use the [Scroll Plugin](/docs/svelte/headless/plugins/plugin-scroll)
