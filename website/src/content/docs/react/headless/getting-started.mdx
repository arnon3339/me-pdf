...
description: Build your first headless PDF viewer with EmbedPDF in just a few steps.
searchable: true
---

# Getting Started with Headless Components

Let's build a basic, scrollable PDF viewer from scratch. This guide walks you through the essential setup.
...
import { PDFViewer } from '../code-examples/headless/simple-pdf-viewer';

<CodeExample 
  codePaths={[
    "content/docs/react/code-examples/headless/simple-pdf-viewer.tsx"
  ]}
>
  <PDFViewer />
</CodeExample>
...
## Next Steps
  ...
  - See a complete implementation with the **[Full Example: MUI Viewer](./full-example)**.
